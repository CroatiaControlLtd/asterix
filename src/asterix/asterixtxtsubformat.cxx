...
bool CAsterixTxtSubformat::WritePacket(CBaseFormatDescriptor &formatDescriptor, CBaseDevice &device, bool &discard)
{
  ...
  if (!Descriptor.m_pAsterixData->getDescription(strPacketDescription))
  {
