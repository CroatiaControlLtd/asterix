...
class AsterixParseTest(unittest.TestCase):
    def test_ParseCAT048(self):
        ...
        with open(sample_filename, "rb") as f:
            ...
            self.assertEqual(packet[0], {'I010': {'SAC': {'desc': 'System Area Code', 'val': 25},
                                         ...
                                         'I170': {'GHO': {'desc': 'GHO', 'val': 0, 'meaning': 'True target track'},
                                         ...
                                         'I220': {'ACAddr': {'desc': 'AircraftAddress', 'val': '3C660C'}}, 'I250': [
                    ...
                    'TId': {'desc': 'Characters 1-8 (coded on 6 bits each) defining target identification',
                            'val': 'DLH65A  '}}, 'category': 48,
                                         'I140': {'ToD': {'desc': 'Time Of Day', 'val': 27354.6015625}},
                                         'I070': {'Mode3A': {'desc': 'Mode-3/A reply code', 'val': '1000'},
                                         ...
                                         'I161': {'Tn': {'desc': 'Track Number', 'val': 3563}},
                                         'I020': {'SIM': {'desc': 'SIM', 'val': 0, 'meaning': 'Actual target report'},
    ...
    def test_ParseCAT062CAT065(self):
        ...
        with open(sample_filename, "rb") as f:
            ...
            self.assertEqual(packet, [{'I220': {'RoC': {'val': -443.75, 'desc': 'Rate of Climb/Descent'}},
                                       'I015': {'SID': {'val': 4, 'desc': 'Service Identification'}}, 'I290': {
                    ...
                    'SSR': {'val': 0.0, 'desc': 'Age of the last secondary detection used to update the track'}},
                                       'I135': {
                                           ...
                                           'CTBA': {'max': 150000.0, 'min': -1500.0, 'val': 15700.0,
                                                    'desc': 'Calculated Track Barometric Alt'}}, 'I136': {
                    'MFL': {'max': 150000.0, 'min': -1500.0, 'val': 15700.0, 'desc': 'Measured Flight Level'}},
                                       'I185': {'Vx': {'max': 8191.75, 'min': -8192.0, 'val': -51.25, 'desc': 'Vx'},
                                                'Vy': {'max': 8191.75, 'min': -8192.0, 'val': 170.0, 'desc': 'Vy'}},
                                       'I080': {'STP': {'meaning': 'default value', 'val': 0, 'desc': ''},
                                       ...
                                       'I070': {'ToT': {'val': 30911.6640625, 'desc': 'Time Of Track Information'}},
                                       'I100': {'Y': {'val': -106114.0, 'desc': 'Y'},
                                                'X': {'val': -239083.0, 'desc': 'X'}},
                                       'I200': {'VERTA': {'meaning': 'Descent', 'val': 2, 'desc': 'Vertical Rate'},
                                                ...
                                                'ADF': {'meaning': 'No altitude discrepancy', 'val': 0,
                                                        'desc': 'Altitude Discrepancy Flag'}}, 'I130': {
                    'Alt': {'max': 150000.0, 'min': -1500.0, 'val': 43300.0, 'desc': 'Altitude'}}, 'category': 62,
                                       'I060': {'CH': {'meaning': 'No Change', 'val': 0, 'desc': 'Change in Mode 3/A'},
                                                'spare': {'const': 0, 'val': 0, 'desc': 'Spare bits set to 0'},
                                                'Mode3A': {'val': '4276',
                                                           'desc': 'Mode-3/A reply in octal representation'}},
                                       'I295': {'MD2': {'val': 0, 'desc': ''}, 'MD5': {'val': 0, 'desc': ''},
                                       ...
                                       'I010': {'SAC': {'val': 25, 'desc': 'System Area Code'},
                                                'SIC': {'val': 100, 'desc': 'System Identification Code'}},
                                       'I340': {'SID': {'val': 1, 'desc': 'Sensor Identification'},
                                                'Mode3A': {'val': '4276',
                                                ...
                                                'L': {
                                                    'meaning': 'MODE 3/A code as derived from the reply of the transponder',
                                                    'val': 0, 'desc': ''},
                                                'MDC': {'val': 1, 'desc': 'Last Measured Mode C code'}}, 'I105': {
                    ...
                    'Lon': {'val': 13.0415278673172,
                            'desc': 'Longitude in WGS.84 in twos complement. Range -180 < longitude < 180 deg.'}},
                                       'I040': {'TrkN': {'val': 4980, 'desc': 'Track number'}},
                                       'I210': {'Ax': {'val': 0.0, 'desc': 'Ax'}, 'Ay': {'val': 0.0, 'desc': 'Ay'}}},
                                      {'I220': {'RoC': {'val': 0.0, 'desc': 'Rate of Climb/Descent'}},
                                       'I015': {'SID': {'val': 4, 'desc': 'Service Identification'}}, 'I290': {
                                          'MDS': {'val': 0.0,
                                       ...
                                       'I185': {'Vx': {'max': 8191.75, 'min': -8192.0, 'val': 141.5, 'desc': 'Vx'},
                                       ...
                                       'I080': {'STP': {'meaning': 'default value', 'val': 0, 'desc': ''},
                                               ...
                                               'val': 1, 'desc': ''},
                                                'AAC': {'meaning': 'Default value', 'val': 0, 'desc': ''},
                                                'SSR': {'meaning': 'Default value', 'val': 0, 'desc': ''}},
                                       'I070': {'ToT': {'val': 30911.828125, 'desc': 'Time Of Track Information'}},
                                       'I100': {'Y': {'val': -36106.5, 'desc': 'Y'},
                                                'X': {'val': -72564.5, 'desc': 'X'}},
                                       'I200': {'VERTA': {'meaning': 'Level', 'val': 0, 'desc': 'Vertical Rate'},
                                                'spare': {'const': 0, 'val': 0, 'desc': 'Spare bit set to zero'},
                                       ...
                                       'I295': {'MD2': {'val': 0, 'desc': ''}, 'MD5': {'val': 0, 'desc': ''},
                                                ...
                                                'FX': {'meaning': 'no extension', 'val': 0,
                                                       'desc': 'Extension indicator'}, 'MHG': {'val': 0, 'desc': ''},
                                                'MD1': {'val': 0, 'desc': ''}, 'MD4': {'val': 0, 'desc': ''}},
                                       'I390': {'FCT': {'val': 1, 'desc': 'Flight Category'},
                                       ...
                                       'I380': {'ACID': {'val': 'SXD4723 ', 'desc': 'Target Identification'},
                                                ...
                                                'BVR': {'val': 0, 'desc': 'Barometric Vertical Rate'}}, 'I105': {
                                          'Lat': {'val': 45.40080785751343,
                                                  'desc': 'Latitude in WGS.84 in twos complement. Range -90 < latitude < 90 deg.'},
                                          'Lon': {'val': 15.13318419456482,
                                                  'desc': 'Longitude in WGS.84 in twos complement. Range -180 < longitude < 180 deg.'}},
                                       'I040': {'TrkN': {'val': 7977, 'desc': 'Track number'}},
                                       'I210': {'Ax': {'val': 0.0, 'desc': 'Ax'}, 'Ay': {'val': 0.0, 'desc': 'Ay'}}},
                                      {'I015': {'SID': {'val': 4, 'desc': 'Service Identification'}},
                                       'I020': {'BTN': {'val': 24, 'desc': 'Batch Number'}},
                                       'I010': {'SAC': {'val': 25, 'desc': 'Source Area Code'},
                                                'SIC': {'val': 100, 'desc': 'Source Identification Code'}},
                                       'category': 65,
                                       'I030': {'ToD': {'val': 30913.0546875, 'desc': 'Time Of Message'}},
                                       'I000': {'Typ': {'meaning': 'End of Batch', 'val': 2, 'desc': 'Message Type'}}}])
